...
%   Microtypography
%----------------------------
\usepackage{microtype}        % Simply loading the package with basic settings is often sufficient
\widowpenalty=10000             % Prevents widows (single lines at the top of a page) (see https://en.wikibooks.org/wiki/LaTeX/Page_Layout#Widows_and_orphans)
...
\usepackage[colorinlistoftodos]{todonotes}         % Introduces the command \todo
...
%   Citation Format
%----------------------------
% See also https://latex-tutorial.com/caption-customization-latex/
...
{%
    \textbf{#1#2}\textit{\small #3} % symbols #1, #2, and #3 are replaced with the caption label, the separator, and the text,
}
...
% \settocbibname{References} % To change the name of the bibliography in the TOC
%----------------------------------------------------------------------------------------
%   FOOTNOTES
%----------------------------------------------------------------------------------------
\renewcommand{\thefootnote}{\roman{footnote}} % Change footnote numbering to roman numerals
